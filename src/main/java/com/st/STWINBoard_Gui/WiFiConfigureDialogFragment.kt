...
import com.st.BlueSTSDK.HSDatalog.WifSettings
...
internal class WiFiConfigureDialogFragment : DialogFragment(){
    ...
    private fun buildCustomView(): View {
        ...
        val view = layoutInflater.inflate(R.layout.stwin_dialog_wifi_conf,null)
        view?.apply {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        dialogBuilder.apply {
            ...
            setPositiveButton(R.string.wifiConf_set_button){ dialog, _ ->
                sendWifiSetting()
                dialog.dismiss()
            }
            setNegativeButton(R.string.wifiConf_cancel_button){ dialog, _ ->
                dialog.dismiss()
            }
        }
